   ...
   const handleAddressSubmit = (event) => {
      event.preventDefault();
       if (newAddressInput.trim() !== "") {
            ...
            setNewAddressInput(""); // Clear input after adding
        }
   }
        ...
        <div className="UserProfile container py-5">
            ...
            {user && (
                <div className="cardUser p-4 mb-4">
                    ...
                    <p className="lead"><strong>Username:</strong> {user.name}</p>
                            ...
                            {addresses.map((addr, index) => (
                                <li key={index} className="list-group-item d-flex justify-content-between align-items-start">
                                    {editAddressIndex === index ? (
                                        <form onSubmit={(e) => handleEditAddressSave(e, addr)} className="edit-address-form">
                                            <textarea
                                            ...
                                            <button type="button" className="btn btn-secondary btn-sm" onClick={() => setEditAddressIndex(null)}>Cancel</button>
                                               </div>
                                        </form>
                    ) : (
                     <>
                       <span className="me-auto">{addr}</span>
                                            <div>
                                                <button
                    ...
                    <form onSubmit={handleAddressSubmit} className="mt-3">
                        <div className="mb-3">
                            <label htmlFor="newAddress" className="form-label visually-hidden">New Full Address:</label>
                            <textarea
                                id="newAddress"
